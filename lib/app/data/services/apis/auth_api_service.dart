...
class AuthApiService {
  ...
  final CurdApiHelper _curdApiHelper = CurdApiHelper.instance;
  ...
  Future<Map<String, dynamic>> registerApiService(AuthEntity authEntity) async {
    try {
      ...
      return successRequest(responseBody: response.data["msg"]);
    } on DioError catch (e) {
  ...
  Future<Map<String, dynamic>> loginApiService(AuthEntity authEntity) async {
    try {
      ...
      return successRequest(responseBody: response.data["token"]);
    } on DioError catch (e) {
